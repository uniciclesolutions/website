...
const privacy = () => {
  return (
    ...
    >
      ...
      <Paragraph>Uni Cycle Solutions Limited</Paragraph>
      <Paragraph>Privacy Policy</Paragraph>
      <Paragraph>For use of data and data processing</Paragraph>
      <Paragraph>1. Terms </Paragraph>
      <Paragraph>
      ...
      <Paragraph>
        1.2. Personal data is any information relating to an identified or
        ...
        and performance of the service. 1.3. Processing of personal data is any
        ...
        out or the means used. 1.4. Restriction of processing is the marking of
        stored personal data with the aim of limiting their processing in the
        future. 1.5. Controller is the natural or legal person, public
        authority, agency or other body which, alone or jointly with others,
        determines the purposes and means of the processing of personal data.
        1.6. Processor is a natural or legal person, public authority, agency or
        other body which processes personal data on behalf of the Controller.
        1.7. A data subject is a person whose personal data is processed. 1.8. A
        ...
        authorized to process personal data. 1.9. Consent of the data subject is
        ...
        data relating to the person. 2. Processing of personal data with the
        consent of data subject 2.1. Personal data shall be processed with the
        ...
        law. 2.2. The data subject shall be entitled to take the consent back at
        ...
        2.3. The data subject gives a clear consent to the Controller to process
        ...
        Solutions Limited. 2.4. Uni Cycle Solutions Limited processes the data
        as a Controller and the Processors are any legal person providing
        services to Uni Cycle Solutions Limited. 2.5. As the Controller, Uni
        ...
        requirements or responsible for establishing such compliance. 2.6. The
        ...
        this does not exceed the limits of the authority of the Processor. 2.7
        ...
        responsibility over the child. 3. Principles and purpose of processing
        personal data 3.1. The purposes of processing personal data are: 3.1.1.
        Identification of the person; 3.1.2. In order to comply with the
        obligations taken and offering services in front of the person; 3.1.3.
        In order to improve services; 3.1.4. In order to send reminders about
        parking (mobile Push, SMS, e-mail) 3.1.5. Asking for feedback; 3.1.6.
        Fulfillment of the obligations provided by law or implementation of the
        permitted uses of the law. 3.2. Controller nor the Processor shall not
        transfer, rent or otherwise give personal data to third parties, unless
        clearly requested so by the person. 3.3. When processing personal data,
        ...
        processing. 3.4. Uni Cycle Solutions Limited works with third persons to
        ...
        same level as of Uni Cycle Solutions Limited itself. 4. The obligations
        of Uni Cycle Solutions Limited 4.1. Uni Cycle Solutions Limited will
        process the data only according to the law. 4.2. Uni Cycle Solutions
        ...
        the purposes of the processing of personal data. 4.3. All provisions
        ...
        Limited Contracts. 4.4. Uni Cycle Solutions Limited is liable for
        compliance with the requirements of the Personal Data Protection Act of
        the United Kingdom and the EU General Data Protection Regulation. 5.
        Protection of the rights of the data subject 5.1. The data subject has
        ...
        his/her personal data. 5.2. The data subject has the right to submit
        ...
        destruction of the data collected. 5.3. The data subject has the right
        to obtain from Uni Cycle Solutions Limited restriction of processing
        where one of the following applies: 5.3.1. the accuracy of the personal
        data is contested by the data subject, for a period enabling the
        Controller to verify the accuracy of the personal data; 5.3.2. the
        processing is unlawful and the data subject opposes the erasure of the
        personal data and requests the restriction of their use instead; 5.3.3.
        the Controller no longer needs the personal data for the purposes of the
        processing, but they are required by the data subject for the
        establishment, exercise or defense of legal claims; 5.3.4. the data
        ...
        Controller override those of the data subject. 5.4. The data subject
        ...
        to which the personal data have been provided. 5.5. The data subject
        ...
        following grounds applies: 5.5.1. the personal data are no longer
        necessary in relation to the purposes for which they were collected or
        otherwise processed; 5.5.2. the data subject withdraws consent on which
        the processing is based according to point 2.1 and where there is no
        other legal ground for the processing; 5.5.3. the data subject objects
        to the processing and there are no overriding legitimate grounds for the
        processing; 5.5.4. the personal data have been unlawfully processed;
        5.5.5. the personal data has to be erased for compliance with a legal
        obligation in applicable law to which the controller is subject. 5.6. If
        ...
        the data. 5.7. Uni Cycle Solutions Limited shall communicate any
        ...
        those recipients if the data subject requests it. 5.8. If the data
        ...
        Limited for the termination or deletion of the violation. 5.9. The data
        ...
        court. 6. Use of Cookies 6.1. Cookies are small data files that host the
        ...
        the computer. 6.2. Uni Cycle Solutions Limited uses cookies. Uni Cycle
        Solutions Limited collects data and cookies from visitors to the web.
        6.3. The cookie-related information is not used to identify the website
        user personally and the pattern data is fully under the control of Uni
        Cycle Solutions Limited. 6.4. Uni Cycle Solutions Limited only uses
        cookies that serve the purposes described above. 6.5. The website
